...
class ContributionController (
    ...
    @PostMapping("/requested-by/{id}")
    fun getContributionsByRequestingUser(@PathVariable id:Int){

    }

    @PostMapping("/confirmed-by/{id}")
    fun getContributionsByConfirmingUser(@PathVariable id:Int){

    }

    @PostMapping("/table/{table}")
    fun getContributionsByTableName(@PathVariable table:String){
